...
The resulting dataset has 1443 varaibles with 35 observations. It now has individual variables representing each activity, from 1 to 1440. There is a variable for the week and day of the study each activity took place as an integer value, as well as a variable that says what specific day of the week each activity took place, whether that was a weekday or weekend.
